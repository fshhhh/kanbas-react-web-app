            ...
            <div>
                <div className="overflow-y-scroll position-absolute bottom-0 end-0 module-position">
                    <Routes>
                        ...
                        <Route path="/Quizzes/quizdetail/:quizId/quizpreview" element={<QuizPreview/>} />
                        <Route path="/Quizzes/quizdetail/:quizId/quizedit" element={<QuizEdit/>} />
                        <Route path="/Quizzes/quizdetail/:quizId/quizedit/quizquestionseditor" element={<QuizQuestionsEditor/>} />
                        <Route path="/Quizzes/quizdetail/:quizId/quizedit/quizdetailseditor" element={<QuizDetailsEditor/>} />
                        <Route path={"/Quizzes/quizdetail/:quizId/quizedit/quizquestionseditor/questionmaker"} element={<QuestionMaker/>}/>
